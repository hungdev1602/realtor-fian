    ...
    <>
      <div className="mt-[120px]">
        ...
        <div className="flex gap-[95px]">
          ...
          <div className="">
            {
              subtitle && <div className="text-[32px] font-[400] mb-[40px] whitespace-pre-line">{subtitle}</div>
            }
              ...
              :
                <>
                  <div className="grid grid-cols-3 gap-[10px]">
                    {
                      choice.slice(0, 3).map((item, index) => (
                        <div 
                          className={"w-[290px] h-[150px] rounded-[20px] flex items-center justify-center relative " + bg}
                          key={index}
                        >
                          <span className="text-[20px] font-[900] absolute top-[15px] left-[15px]">{item.id}</span>
                          <div className="text-[18px] font-[500] text-center whitespace-pre-line ">{item.title}</div>
                  ...
                  <div className="flex items-center gap-[10px] mt-[10px] mb-[170px]">
                    {
                      choice.slice(3).map((item, index) => (
                        <div 
                          className={(index === 2 ? "w-[270px] " : index === 1 ? "w-[150px] " : "w-[220px] ") + "h-[150px] rounded-[20px] flex items-center justify-center relative " + bg}
                          key={index}
                        >
                          <span className="text-[20px] font-[900] absolute top-[15px] left-[15px]">{item.id}</span>
                          <div className="text-[18px] font-[500] text-center whitespace-pre-line ">{item.title}</div>
