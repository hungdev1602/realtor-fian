...
const ServiceDetailType3 = (props) => {
  const {
    title,
    desc,
    choice=[],
    ...
    <>
      <div className="mt-[120px] h-[777px]">
        ...
        <div className="mt-[-450px]">
          <div className="w-[930px] grid grid-cols-3 gap-[10px] flex-wrap mb-[10px]">
            {
          ...
          <div className="w-[930px] grid grid-cols-4 gap-[10px] flex-wrap mb-[40px]">
            {
...
export default ServiceDetailType3