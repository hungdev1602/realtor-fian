    ...
    <>
      <div className="mt-[20px] sm:mt-[80px] h-fit lg:h-[335px] xl:h-[403px] 2xl:h-[524px]">
        ...
        <div className="mt-[30px] flex justify-between flex-wrap md:flex-nowrap">
          {/* Left */}
          <div className="">
            <div className="text-[22px] sm:text-[43px] xl:text-[48px] 2xl:text-[64px] font-[400] font-avenir leading-[57px] whitespace-pre-line">{title}</div>
          ...
          {/* Right */}
          <div className="w-full sm:w-[360px] xl:w-[473px] 2xl:w-[603px] h-auto sm:h-[335px] xl:h-[402px] 2xl:h-[456px] rounded-[20px] mt-[15px] sm:mt-0">
        ...
        <div className="w-full sm:w-[785px] mt-[15px] lg:mt-[-155px] xl:mt-[-197px]">
          ...
          <button 
            className="inline-block w-full sm:w-auto py-[17px] sm:py-[20px] xl:py-[23px] px-[82px] 2xl:px-[100px] bg-[#333333] text-[14px] sm:text-[18px] xl:text-[20px] 2xl:text-[24px] text-[#fff] rounded-[20px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] hover:bg-[#fff] hover:text-[#333] transition-all duration-150"
          >
            {btnTitle}
          </button>
        </div>
