      ...
      <div className="mt-[20px] sm:mt-[80px] h-fit">
        <div className="mt-[30px] flex justify-between flex-wrap lg:flex-nowrap">
          ...
          <div className="w-[660px] 2xl:w-auto">
            ...
            <div className="text-[12px] sm:text-[20px] font-[400] mt-[-5px] sm:mt-[15px] whitespace-pre-line mb-[30px] sm:mb-0">{subtitle}</div>
        ...
        <div className="w-full sm:w-[560px] xl:w-[640px] 2xl:w-[785px] mt-0 lg:mt-[-220px] xl:mt-[-168px] 2xl:mt-[-197px]">
          <div className="grid grid-cols-2 gap-[24px] 2xl:gap-[42px] mb-[15px] sm:mb-[40px]">
            <div className="">
              <div className="text-[12px] sm:text-[24px] 2xl:text-[32px] font-[600]">{minititle[0]["title"]}</div>
              <div className="text-[10px] sm:text-[18px] 2xl:text-[18px] font-[400] text-[#000000CC]">{minititle[0]["desc"]}</div>
            </div>
            <div className="">
              <div className="text-[12px] sm:text-[24px] 2xl:text-[32px] font-[600]">{minititle[1]["title"]}</div>
              <div className="text-[10px] sm:text-[18px] 2xl:text-[18px] font-[400] text-[#000000CC]">{minititle[1]["desc"]}</div>
            </div>
          </div>
