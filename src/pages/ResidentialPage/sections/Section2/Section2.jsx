      ...
      <div className="mt-[80px] sm:mt-[120px]">
        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-[30px] 2xl:gap-[95px]">
          ...
          <div className="w-full md:w-auto">
            <div className="text-[12px] sm:text-[24px] 2xl:text-[32px] font-[400] mb-[20px] sm:mb-[40px] whitespace-pre-line">{subtitle}</div>
            {/* On PC */}
            {/* 1 Row */}
            ...
            <button 
              className="w-full sm:w-auto inline-block py-[17px] sm:py-[23px] px-[106px] 2xl:px-[100px] bg-[#333333] text-[14px] sm:text-[20px] 2xl:text-[24px] text-[#fff] rounded-[20px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] hover:bg-[#fff] hover:text-[#333] transition-all duration-150"
            >
              {btnTitle}
            </button>
          </div>
