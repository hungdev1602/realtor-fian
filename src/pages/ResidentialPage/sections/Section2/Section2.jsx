          ...
          <div className="">
            <div className="text-[32px] font-[400] mb-[40px] whitespace-pre-line">{subtitle}</div>
              ...
              <div className="flex gap-[10px]">
                ...
                {/* 4 item */}
                <div 
                  className={"w-[225px] h-[150px] rounded-[20px] flex items-center justify-center relative " + bg}
                >
              ...
              {/* 2 Row */}
              <div className="flex gap-[10px] mt-[10px] mb-[100px]">
                {/* 5 item */}
                <div 
                  className={"w-[200px] h-[150px] rounded-[20px] flex items-center justify-center relative " + bg}
                >
                ...
                {/* 6 item */}
                <div 
                  className={"w-[360px] h-[150px] rounded-[20px] flex items-center justify-center relative " + bg}
                >
