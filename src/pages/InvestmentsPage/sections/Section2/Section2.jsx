    ...
    <>
      <div className="mt-[80px] sm:mt-[120px]">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-0 md:gap-[40px] 2xl:gap-[45px]">
          {/* Left */}
          <div className="w-full 2xl:w-[800px] truncate rounded-[20px]">
            <img src={image} alt="" className="w-full h-full object-cover"/>
          </div>

          {/* Right */}
          <div className="w-full mt-[15px] md:mt-0">            
            {/* 1 Row */}
            ...
            <div className="flex gap-[10px] mb-[15px] sm:mb-[80px]">
              ...
              >
                ...
                <div className="text-[10px] md:text-[18px] font-[500] text-center whitespace-pre-line ">{choice[8].title}</div>
              </div>
            </div>
