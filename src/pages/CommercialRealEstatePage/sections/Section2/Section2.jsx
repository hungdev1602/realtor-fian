      ...
      <div className="text-[24px] xl:text-[48px] 2xl:text-[64px] font-[500] font-avenir mb-[15px] sm:mb-[40px] leading-[21px] sm:leading-normal">{title}</div>
        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-[30px] 2xl:gap-[95px]">
          ...
          <div className="w-full sm:w-auto">
            ...
            <button 
              className="w-full sm:w-auto inline-block py-[17px] sm:py-[23px] px-[106px] bg-[#333333] text-[14px] sm:text-[20px] 2xl:text-[24px] text-[#fff] rounded-[20px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] hover:bg-[#fff] hover:text-[#333] transition-all duration-150"
            >
              {btnTitle}
            </button>
          </div>
