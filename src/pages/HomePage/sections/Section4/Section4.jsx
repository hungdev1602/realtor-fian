...
const Section4 = () => {
  return (
    <>
      <div className="container mx-auto mt-[80px] sm:mt-[120px]" id="services">
        <Title title="Услуги" />
      ...
      <div className="bg-[#8F4449] py-[15px] sm:py-[20px] lg:py-[38px] px-[10px] sm:px-[40px] mt-[46px] rounded-[10px] sm:rounded-[20px] sm:container sm:mx-auto">
        <div className={" " + (window.innerWidth < 576 ? "container mx-auto flex justify-between items-center" : "flex justify-between items-center")}>
          <div className="flex items-center justify-between gap-[20px]">
            <img src={discount} alt="" className="w-[40px] md:w-[63px] h-auto"/>
            <div className="text-[#fff]">
              <div className="text-[16px] sm:text-[20px] md:text-[32px] font-[400] text-[#F4ECED]">Скидка 5%</div>
              <div className="text-[10px] md:text-[18px] font-[400] text-[#FFFFFFCC]">При принятии решения до 2х дней</div>
            </div>
          </div>
